<div class="flex flex-row flex-wrap bg-{{ $brand }} corners-3 pa {{ !empty($compact) && $compact === true ? 'compact' : '' }}">
...
@if($progress === 100)
    <div class="flex flex-row bg-white corners-bottom-3 pa bb-recordeo-3">
