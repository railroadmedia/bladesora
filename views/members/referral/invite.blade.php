        ...
        <div class="tw-flex tw-flex-col xl:tw-flex-row tw-items-center tw-px-4 {{ $containerClass }}">
            ...
            @if($canRefer)
                <div class="tw-flex tw-flex-col lg:tw-h-full lg:tw-pl-10 tw-w-full tw-max-w-lg lg:tw-max-w-none tw-mx-auto">
                    ...
                    <form id="invite-email-form" name="drumeo" method="post" action="{{ $emailInviteUrl }}">
                        ...
                        <div class="tw-flex tw-flex-wrap sm:tw-flex-nowrap tw-items-center tw-justify-center tw-mt-1">
                            <input class="tw-inline-block tw-w-full tw-mb-4 sm:tw-mb-0 sm:tw-mr-4 tw-default-form-field sm:tw-flex-grow tw-pt-0" type="email" id="email" name="email" placeholder="Email address..." value="{{ Input::old('email') }}">
                    ...
                    <form id="invite-link-form" name="drumeo" method="post" action="#">
