...
<section class="tw-flex tw-flex-wrap tw-justify-center xl:tw-grid xl:tw-grid-cols-3 xl:tw-gap-2 tw-mb-6">
    ...
    <div class="md:tw-px-1 xl:tw-px-0 tw-mb-2 xl:tw-mb-0 tw-w-full xl:tw-w-full">
        <div class="tw-h-full tw-bg-cover tw-bg-center tw-text-white tw-text-center tw-rounded-lg tw-p-8" style="background-image: url('{{ $methodBgImg }}');">
    ...
    <div class="md:tw-px-1 xl:tw-px-0 tw-mb-2 xl:tw-mb-0 tw-w-full md:tw-w-1/2 xl:tw-w-full">
        <div class="tw-h-full tw-bg-cover tw-bg-center tw-text-white tw-text-center tw-rounded-lg tw-p-8" style="background-image: url('{{ $songsBgImg }}');">
    ...
    <!-- Coaches -->
    <div class="md:tw-px-1 xl:tw-px-0 tw-mb-2 xl:tw-mb-0 tw-w-full md:tw-w-1/2 xl:tw-w-full">
        <div class="tw-h-full tw-bg-cover tw-bg-center tw-text-white tw-text-center tw-rounded-lg tw-p-8" style="background-image: url('{{ $coachCardBg }}');">
